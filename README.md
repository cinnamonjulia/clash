...
- **`data/districts.json`** — the same data in structured form, ready for a future app to
...
3. Build a simple, shareable web app that reads `data/districts.json` — calendar view +
