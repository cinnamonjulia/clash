// AUTO-GENERATED from ../data/districts.json — do not edit by hand.
window.CALENDER_DATA = {
  "schoolYear": "2026-2027",
  "region": "BBYO Eastern Region",
  "states": [
    "NC",
    "SC",
    "VA"
  ...
  "notes": "First-pass data gathered from official district pages + calendar aggregators. Dates marked verify:true still need a check against the district's official PDF. Graduation dates are mostly published in spring; TBD entries will be filled when districts post them.",
  "districts": [
    {
      "id": "cms-nc",
